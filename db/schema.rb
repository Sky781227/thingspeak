...
ActiveRecord::Schema.define(version: 20160211232009) do
  ...
  add_index "api_keys", ["device_id"], name: "index_api_keys_on_device_id", using: :btree
  ...
  add_index "feeds", ["device_id"], name: "index_feeds_on_device_id", using: :btree
  ...
  add_index "twitter_accounts", ["api_key"], name: "index_twitter_accounts_on_api_key", using: :btree
  add_index "twitter_accounts", ["twitter_id"], name: "index_twitter_accounts_on_twitter_id", using: :btree
